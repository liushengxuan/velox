...
#include "velox/dwio/common/reader/SelectiveColumnReader.h"
...
class DwrfSelectiveColumnReader : public dwio::common::reader::SelectiveColumnReader {
 public:
...
//  }
  ...
  static std::unique_ptr<DwrfSelectiveColumnReader> build(
...
//
//template <>
//inline void DwrfSelectiveColumnReader::addValue(const folly::StringPiece value) {
...
//}
//
//class DwrfSelectiveColumnReaderFactory : public SelectiveColumnReaderFactory {
// public:
//  explicit DwrfSelectiveColumnReaderFactory(
//      std::shared_ptr<common::ScanSpec> scanSpec)
//      : scanSpec_(scanSpec) {}
//  std::unique_ptr<SelectiveColumnReader> build(
//      const std::shared_ptr<const dwio::common::TypeWithId>& requestedType,
//      const std::shared_ptr<const dwio::common::TypeWithId>& dataType,
//      StripeStreams& stripe,
//      FlatMapContext flatMapContext) override {
//    auto reader = DwrfSelectiveColumnReader::build(
//        requestedType,
//        dataType,
//        stripe,
//        scanSpec_.get(),
