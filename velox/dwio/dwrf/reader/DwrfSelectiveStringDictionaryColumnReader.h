...
class DwrfSelectiveStringDictionaryColumnReader : public DwrfSelectiveColumnReader {
 public:
  using ValueType = int32_t;

  DwrfSelectiveStringDictionaryColumnReader(
...
template <typename TVisitor>
void DwrfSelectiveStringDictionaryColumnReader::readWithVisitor(
    RowSet rows,
    TVisitor visitor) {
...
template <typename TFilter, bool isDense, typename ExtractValues>
void DwrfSelectiveStringDictionaryColumnReader::readHelper(
    common::Filter* filter,
    RowSet rows,
...
template <bool isDense, typename ExtractValues>
void DwrfSelectiveStringDictionaryColumnReader::processFilter(
    common::Filter* filter,
    RowSet rows,
    ExtractValues extractValues) {
