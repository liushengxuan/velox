...
//
//#include "velox/dwio/dwrf/reader/DwrfSelectiveByteRleColumnReader.h"
//#include "velox/dwio/dwrf/reader/DwrfSelectiveColumnReaderInternal.h"
//
//#include "velox/dwio/dwrf/reader/DwrfSelectiveFloatingPointColumnReader.h"
//#include "velox/dwio/dwrf/reader/DwrfSelectiveIntegerDictionaryColumnReader.h"
//#include "velox/dwio/dwrf/reader/DwrfSelectiveIntegerDirectColumnReader.h"
...
//#include "velox/dwio/dwrf/reader/DwrfSelectiveTimestampColumnReader.h"
//
...
SelectiveColumnReader::SelectiveColumnReader(
    ...
    : DwrfColumnReader(std::move(requestedType), stripe, std::move(flatMapContext)),
      scanSpec_(scanSpec),
      type_{type},
...
//
//std::unique_ptr<DwrfSelectiveColumnReader> buildIntegerReader(
