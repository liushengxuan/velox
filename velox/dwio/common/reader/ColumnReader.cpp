...
//      To Dwrf: dwrf::EPOCH_OFFSET is temprarily here. It will be moved to facebook::velox::dwio +++
...
//      To Dwrf: Proto related will be move to dwrf +++
...
//      To Dwrf: This constructor is duplicated after moving some members to Dwrf. Need to be implemented in Dwrf +++
...
// ------------------------
//     To Dwrf: all the XXXColumnReaders are to be moved to Dwrf +++
...
//      To Dwrf: ColumnReaderFactory is to be moved to DwrfColumnReaderFactory. +++
